...
void hid_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(
        app->submenu, "数字键盘", HidSubmenuIndexNumpad, hid_scene_start_submenu_callback, app);
    submenu_add_item(
        app->submenu, "媒体", HidSubmenuIndexMedia, hid_scene_start_submenu_callback, app);
    submenu_add_item(
        app->submenu,
        "Apple Music macOS",
        HidSubmenuIndexMusicMacOs,
        ...
        app);
    submenu_add_item(
        app->submenu, "影片", HidSubmenuIndexMovie, hid_scene_start_submenu_callback, app);
    submenu_add_item(
