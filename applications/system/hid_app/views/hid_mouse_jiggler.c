...
static void hid_mouse_jiggler_draw_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 27, 2, AlignLeft, AlignTop, "鼠标抖动器");

    // Timeout
    elements_multiline_text(canvas, AlignLeft, 26, "间隔(毫秒):");
    ...
    canvas_set_font(canvas, FontPrimary);
    elements_multiline_text(canvas, AlignLeft, 40, "按开始\n开始抖动");
    canvas_set_font(canvas, FontSecondary);
