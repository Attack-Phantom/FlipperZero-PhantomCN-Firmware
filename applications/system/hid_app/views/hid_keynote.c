...
static void hid_keynote_draw_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 127, 3, AlignRight, AlignTop, "长按退出");
    ...
    elements_multiline_text_aligned(canvas, 91, 36, AlignLeft, AlignBottom, "空格");
    canvas_set_color(canvas, ColorBlack);
    ...
    elements_multiline_text_aligned(canvas, 91, 57, AlignLeft, AlignBottom, "返回");
}
...
static void hid_keynote_draw_vertical_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 26, 98, AlignLeft, AlignBottom, "空格");
    canvas_set_color(canvas, ColorBlack);
    ...
    elements_multiline_text_aligned(canvas, 26, 119, AlignLeft, AlignBottom, "返回");
}
