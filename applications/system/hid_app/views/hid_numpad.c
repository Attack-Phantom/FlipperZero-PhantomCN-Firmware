...
static void hid_numpad_draw_callback(Canvas* canvas, void* context) {
    ...
    if(model->connected) {
        ...
        elements_multiline_text_aligned(
            canvas, 7, 60, AlignLeft, AlignBottom, "等待\n连接...");
    }
    elements_multiline_text_aligned(canvas, 20, 3, AlignLeft, AlignTop, "数字键盘");

#else
    elements_multiline_text_aligned(canvas, 12, 3, AlignLeft, AlignTop, "数字键盘");
#endif
