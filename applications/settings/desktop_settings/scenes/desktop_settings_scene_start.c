...
void desktop_settings_scene_start_on_enter(void* context) {
    ...
    variable_item_list_add(variable_item_list, "PIN 设置", 1, NULL, NULL);

    variable_item_list_add(variable_item_list, "按键绑定设置", 1, NULL, NULL);

    variable_item_list_add(variable_item_list, "按键绑定恢复默认", 1, NULL, NULL);
    ...
    variable_item_set_current_value_text(item, app->settings.auto_lock_with_pin ? "开" : "关");
