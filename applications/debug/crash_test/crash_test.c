...
CrashTest* crash_test_alloc(void) {
    ...
    submenu_add_item(
        instance->submenu, "检查", CrashTestSubmenuCheck, crash_test_submenu_callback, instance);
    submenu_add_item(
        instance->submenu,
        "带消息检查",
        CrashTestSubmenuCheckMessage,
        ...
        instance);
    submenu_add_item(
        instance->submenu, "断言", CrashTestSubmenuAssert, crash_test_submenu_callback, instance);
    submenu_add_item(
        instance->submenu,
        "带消息断言",
        CrashTestSubmenuAssertMessage,
        ...
        instance);
    submenu_add_item(
        instance->submenu, "崩溃", CrashTestSubmenuCrash, crash_test_submenu_callback, instance);
    submenu_add_item(
        instance->submenu, "停机", CrashTestSubmenuHalt, crash_test_submenu_callback, instance);
    submenu_add_item(
        instance->submenu,
        "Heap underflow",
        CrashTestSubmenuHeapUnderflow,
