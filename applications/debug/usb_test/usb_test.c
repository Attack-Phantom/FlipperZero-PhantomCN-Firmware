...
UsbTestApp* usb_test_app_alloc(void) {
    ...
    submenu_add_item(
        app->submenu, "启用", UsbTestSubmenuIndexEnable, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu, "禁用", UsbTestSubmenuIndexDisable, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu, "重新开始", UsbTestSubmenuIndexRestart, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu, "单路 VCP", UsbTestSubmenuIndexVcpSingle, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu, "双路 VCP", UsbTestSubmenuIndexVcpDual, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu, "HID 键鼠", UsbTestSubmenuIndexHid, usb_test_submenu_callback, app);
    submenu_add_item(
        app->submenu,
        "HID 键鼠(自定义 ID)",
        UsbTestSubmenuIndexHidWithParams,
