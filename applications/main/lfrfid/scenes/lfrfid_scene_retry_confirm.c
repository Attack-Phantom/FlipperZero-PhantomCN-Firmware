...
void lfrfid_scene_retry_confirm_on_enter(void* context) {
    ...
    widget_add_button_element(widget, GuiButtonTypeRight, "留下", lfrfid_widget_callback, app);
    widget_add_string_element(widget, 64, 0, AlignCenter, AlignTop, FontPrimary, "重试读取?");
    widget_add_string_element(
        widget, 64, 13, AlignCenter, AlignTop, FontSecondary, "所有未保存数据将丢失");
