...
static void momentum_app_scene_interface_filebrowser_favorite_timeout_changed(VariableItem* item) {
    ...
    variable_item_set_current_value_text(item, value ? text : "关");
...
void momentum_app_scene_interface_filebrowser_on_enter(void* context) {
    ...
    variable_item_set_current_value_text(item, momentum_settings.sort_dirs_first ? "开" : "关");
    ...
    variable_item_set_current_value_text(item, momentum_settings.show_hidden_files ? "开" : "关");
    ...
    variable_item_set_current_value_text(item, momentum_settings.show_internal_tab ? "开" : "关");
    ...
    variable_item_set_current_value_text(item, momentum_settings.favorite_timeout ? text : "关");
