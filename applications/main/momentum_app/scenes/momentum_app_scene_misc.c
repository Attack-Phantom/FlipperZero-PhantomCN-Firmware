...
void momentum_app_scene_misc_on_enter(void* context) {
    ...
    item = variable_item_list_add(var_item_list, "伪造选项", 0, NULL, app);
    variable_item_set_current_value_text(item, ">");

    item = variable_item_list_add(var_item_list, "VGM 选项", 0, NULL, app);
    variable_item_set_current_value_text(item, ">");

    variable_item_list_add(var_item_list, "显示 Momentum 介绍", 0, NULL, app);
